...
**फॉरेक्स** = विदेशी विनिमय — एक देश की मुद्रा को दूसरे देश की मुद्रा से बदलना। यह दुनिया का सबसे बड़ा वित्तीय बाज़ार है, जहाँ रोज़ाना **$7 ट्रिलियन** से ज़्यादा का कारोबार होता है।

### उदाहरण
आप पाकिस्तान में रहते हैं। आपके पास 1000 रुपये हैं। आप डॉलर की कीमत बढ़ने से पहले डॉलर खरीद लेते हैं। जब डॉलर महंगा हो जाता है, तो आप उसे बेचकर रुपये में मुनाफ़ा कमाते हैं। फॉरेक्स में यही काम ऑनलाइन होता है।

### मुख्य बिंदु
1. यहाँ हम **मुद्राएँ** खरीदते और बेचते हैं
2. यहाँ कोई भौतिक मुद्रा नहीं आती — सब कुछ ऑनलाइन होता है
3. बाज़ार हफ़्ते में 5 दिन, 24 घंटे खुला रहता है`,
      ar: `## ما هو الفوركس؟
...
फॉरेक्स में हम मुद्रा को अकेले नहीं खरीदते — हमेशा **जोड़े** में खरीदते हैं।

### 1. Currency Pairs = मुद्रा जोड़े
उदाहरण: \`EUR/USD\` यानी Euro को Dollar के मुकाबले खरीदना
अगर आप \`EUR/USD\` खरीदते हैं, तो मतलब आप Euro खरीद रहे हैं और Dollar बेच रहे हैं।

लोकप्रिय Pairs: \`EUR/USD\`, \`GBP/USD\`, \`USD/PKR\`, \`GBP/JPY\`

### 2. Pips = पिप्स
यह मुद्रा की कीमत में सबसे छोटा बदलाव है।
उदाहरण: \`EUR/USD\` 1.1000 से 1.1001 हुआ = 1 Pip का फ़र्क

### 3. Spread = स्प्रेड
यह Buy और Sell की कीमत का फ़र्क है। यह ब्रोकर की फ़ीस है।
उदाहरण: \`EUR/USD\` Buy = 1.1002 और Sell = 1.1000
तो Spread = 2 Pips

### उदाहरण
आपने \`EUR/USD\` को 1.1000 पर Buy किया।
TP 1.1010 पर लगाया। फ़र्क = 10 Pips
अगर 0.01 Lot लगाएँ तो 10 Pips = $1 Profit बनेगा`,
...
ये 3 चीज़ें आपके Risk और Profit को नियंत्रित करती हैं।

### 1. Lot Size = लॉट साइज़
यह आपके Trade का "साइज़" है। जितना बड़ा Lot, उतना बड़ा Profit या Loss।

- \`1.0 Lot\` = Standard Lot
- \`0.10 Lot\` = Mini Lot
- \`0.01 Lot\` = Micro Lot ← Beginners के लिए सबसे अच्छा

### 2. Leverage = लीवरेज
यह ब्रोकर का दिया हुआ "क़र्ज़" है। इससे आप कम पैसों से बड़ा Trade कर सकते हैं।
उदाहरण: Leverage 1:1000
आपके पास $10 हैं तो आप $10,000 का Trade कर सकते हैं।

### 3. Margin = मार्जिन
यह वह रकम है जो ब्रोकर आपसे "सिक्योरिटी" के तौर पर रोक लेता है।
फ़ॉर्मूला: Margin = Lot Size x Contract Size / Leverage

### उदाहरण
EUR/USD का 0.01 Lot लगाएँ
Leverage 1:1000 है तो Margin बहुत कम लगेगा
और 100 Pips चलें तो $10 Profit बनेगा`,
...
फॉरेक्स मार्केट सोमवार से शुक्रवार तक 24 घंटे खुली रहती है क्योंकि दुनिया के अलग-अलग देशों की मार्केट बारी-बारी से खुलती हैं।

### 4 बड़े सेशन (पाकिस्तान का समय)

| सेशन | पाकिस्तान का समय | नोट |
|------|----------------|-----|
| Sydney | सुबह 5:00 से दोपहर 1:00 | सुस्त मार्केट |
| Tokyo | सुबह 8:00 से शाम 4:00 | JPY, AUD की मूवमेंट |
| London | दोपहर 1:00 से रात 9:00 | सबसे ज़्यादा Volatility |
| New York | शाम 6:00 से रात 2:00 | USD की सबसे बड़ी मूवमेंट |

### अहम समय
**London + New York Overlap** = शाम 6:00 से रात 9:00 पाकिस्तान टाइम
इस समय \`EUR/USD\` में सबसे ज़्यादा मूवमेंट होती है।

### उदाहरण
अगर आप \`EUR/USD\` ट्रेड करते हैं तो बेहतरीन समय शाम 6:00 से रात 9:00 है`,
      ar: `## جلسات السوق
...
### 2 प्रकार
1. **हरी / Bullish** = Close > Open = खरीददार जीते
2. **लाल / Bearish** = Close < Open = बेचने वाले जीते

### उदाहरण
\`EUR/USD\` की 1 घंटे वाली कैंडल:
Open 1.1000, High 1.1020, Low 1.0990, Close 1.1015
यह **हरी कैंडल** है क्योंकि 1.1015 > 1.1000। मतलब Euro ताक़तवर हुआ।`,
...
**Support** = फ़र्श — कीमत यहाँ से ऊपर जाती है
**Resistance** = छत — कीमत यहाँ से नीचे आती है

### उदाहरण
\`EUR/USD\` बार 1.0950 पर आ कर ऊपर गया = यह **Support** है
\`EUR/USD\` बार 1.1050 पर जा कर नीचे आया = यह **Resistance** है
...
**Uptrend:** ऊँचे High + ऊँचे Low → सिर्फ़ Buy ढूँढें
**Downtrend:** नीचे Low + नीचे High → सिर्फ़ Sell ढूँढें

### उदाहरण
अगर \`EUR/USD\` लगातार 1.0950, 1.0980, 1.1000 Low बना रहा है तो यह **Uptrend** है।
हम Pullback पर Buy लेंगे।`,
...
### 1. Market Order
तुरंत मौजूदा कीमत पर Buy/Sell (उदाहरण: 1.1000 पर Buy)

### 2. Buy Limit
कम कीमत पर Buy — उदाहरण: जब कीमत 1.0980 (Support) पर आए तो Buy हो जाए

### 3. Buy Stop
मौजूदा कीमत से ऊपर Buy — उदाहरण: जब 1.1050 (Resistance) टूटे तो 1.1051 पर Buy हो जाए

### नोट
\`EUR/USD\` में आमतौर पर Spread बहुत कम होता है — 0.1 से 0.3 Pips`,
      ar: `## أنواع الأوامر
...
**2% नियम:** $100 अकाउंट = एक Trade में ज़्यादा से ज़्यादा $2 Risk
...
**लालच:** $4 Profit हुआ, TP हटा दिया। कीमत वापस आ कर SL लगा गया
**डर:** 2 Trade Loss हुए तो Demo बंद कर दिया

### हल
- रोज़ाना 2% से ज़्यादा Loss नहीं करना
- हफ़्ते में 5 दिन, रोज़ 2 Trade — बस काफ़ी है`,
...
### स्टेप बाय स्टेप
1. Demo Account Open करें
2. **Platform:** MT5
3. **Account Type:** Micro या Cent
4. **Balance:** $10,000
5. **Leverage:** 1:1000
6. **Symbol:** \`EUR/USD\` सर्च करें

### 30 दिन Practice प्लान
- **हफ़्ता 1:** सिर्फ़ \`EUR/USD\` पर 0.01 Lot, London सेशन
- **हफ़्ता 2:** Support/Resistance + SL TP के साथ
- **हफ़्ता 3:** सिर्फ़ 1:2 Risk Reward वाले Trade
- **हफ़्ता 4:** अगर Balance $10,500+ है तो Real से शुरू`,
...
1. \`EUR/USD\` में Base Currency कौन सी है?
2. 0.01 Lot में 50 Pips = कितने $? जवाब: $5
3. \`EUR/USD\` 1.1000 से 1.1010 गया = कितने Pips?
4. London + NY Overlap पाकिस्तान का क्या समय है?
5. 2% Rule की मिसाल दें
6. लाल कैंडल का मतलब?
7. Resistance टूट जाए तो क्या बन जाता है?
8. Buy Stop कब लगाते हैं?
9. Leverage 1:1000 से क्या फ़ायदा?
10. Real से पहले Demo क्यों ज़रूरी?
