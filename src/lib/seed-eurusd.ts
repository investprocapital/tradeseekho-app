...
الفوركس = سوق الصرف الأجنبي. إنه أكبر سوق مالي في العالم.`,
    },
    durationMin: 5,
    isFree: true,
    questions: [
...
في الفوركس نشتري العملات في أزواج وليس بشكل فردي.`,
    },
    durationMin: 6,
    isFree: true,
    questions: [
...
سوق الفوركس يعمل من الإثنين إلى الجمعة على مدار 24 ساعة.`,
    },
    durationMin: 5,
    isFree: true,
    questions: [
...
1 شمعة = 4 أشياء: الافتتاح، الإغلاق، الأعلى، الأدنى`,
    },
    durationMin: 5,
    isFree: true,
    questions: [
...
صاعد: قمم أعلى + قيعان أعلى → شراء
هابط: قيعان أدنى + قمم أدنى → بيع`,
    },
    durationMin: 5,
    isFree: true,
    questions: [
...
سوق، حد، إيقاف — متى تستخدم كل نوع.`,
    },
    durationMin: 5,
    isFree: true,
    questions: [
...
حساب $100 = حد أقصى $2 مخاطرة في الصفقة`,
    },
    durationMin: 5,
    isFree: true,
    questions: [
...
الطمع والخوف — أكبر أعداء المتداول.`,
    },
    durationMin: 4,
    isFree: true,
    questions: [
